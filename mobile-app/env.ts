...
const envSchema = z.object({
  ...
  EXPO_PUBLIC_MMKV_ENCRYPTION_KEY: z.string().optional(),
...
const BUNDLE_IDS = {
  development: 'com.pickrr.mobile.dev',
  preview: 'com.pickrr.mobile.preview',
  production: 'com.pickrr.mobile',
} as const;
...
const SCHEMES = {
  development: 'pickrr-mobile-dev',
  preview: 'pickrr-mobile-preview',
  production: 'pickrr-mobile',
} as const;
